# Story Frame Component Specification
...
The system SHALL handle old stories without cover_image_path gracefully.
...
- **AND** the story SHALL play normally without Story Frame
- **AND** the Pages panel SHALL be enabled (no gating for legacy stories)
