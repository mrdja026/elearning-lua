...
- [x] 1.3.3 Test backend starts without errors
...
- [x] 3.1.5 **TEST**: curl test researcher endpoint
- [x] 3.1.6 **MANUAL**: Confirm response has facts + source URLs
...
- [x] 3.2.5 **TEST**: curl test storyteller endpoint
- [x] 3.2.6 **MANUAL**: Confirm response has title, 3 pages with questions
...
- [x] 3.3.5 **TEST**: curl test critic endpoint
- [x] 3.3.6 **MANUAL**: Confirm response has approved, warnings, readabilityScore
...
- [x] 3.4.5 **TEST**: curl test full pipeline
- [x] 3.4.6 **MANUAL**: Confirm full pipeline output
...
### 4.3 Wizard Testing
- [x] 4.3.1 **TEST**: Full wizard flow with curl
- [x] 4.3.2 **MANUAL**: Confirm wizard flow works end-to-end
...
- [x] 5.1.4 **TEST**: curl test one-shot endpoint
- [x] 5.1.5 **MANUAL**: Confirm complete story output
...
> Implemented in separate `add-creator-studio-wizard` change.

- [x] 7.1 (DEFERRED) Update `schema.lua` with new metadata fields → moved to add-creator-studio-wizard
- [x] 7.2 (DEFERRED) Add AI Generate wizard modal to `editor.lua` → moved to add-creator-studio-wizard
- [x] 7.3 (DEFERRED) Wire up Lua HTTP calls to wizard endpoints → moved to add-creator-studio-wizard
